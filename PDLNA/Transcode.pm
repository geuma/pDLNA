...
package PDLNA::Transcode - to manage transcoding of content stream based on device capabilities.

=head1 DESCRIPTION

This module works out whether need to transcode and what formats can transcode to.
