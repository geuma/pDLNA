...
package PDLNA::Media - to define media formats.

=head1 DESCRIPTION

This module defines audio and video codecs and works out
the url's needed.
...
=item audio_codec_by_beautiful_name()
...
=item video_codec_by_beautiful_name()
...
=item container_by_beautiful_name()
...
=item container_supports_audio_codec()
...
=item get_mimetype_by_modelname()
